...
TypeScript 5.9.3, and the corresponding React/Node/lodash/hoist-non-react-statics types.
...
The Vite probe creates two builds with a retained cache and verifies repair of
duplicate store IDs. It removes the temporary consumer's manager ID cache. The SSR probe
